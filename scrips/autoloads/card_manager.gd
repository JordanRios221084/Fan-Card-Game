...
func move_card_to_position(card: Node2D, target_pos: Vector2, target_time_seconds: float, target_rot_degrees: float) -> void:
	...
	move_tween.tween_property(card, "rotation", deg_to_rad(target_rot_degrees), target_time_seconds*1.2)
...
## ## Desvanece y elimina una carta del juego mediante una animación de escala hacia abajo.
